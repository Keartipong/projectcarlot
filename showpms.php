...
// ตัวอย่างการอัพเดทข้อมูลใหม่
setInterval(() => {
    // จำลองการดึงข้อมูลใหม่
    let newData = `New Data: ${Math.random().toFixed(2)}`;

    // เงื่อนไข: อัพเดทข้อมูลเมื่อข้อมูลใหม่แตกต่างจากข้อมูลเดิม
    if (newData !== currentData) {
        currentData = newData;
        showData(newData);
    }
}, 1000); // ทุกๆ 10 วินาที ลองดึงข้อมูลใหม่
